...
layout: post
title: Figure 11
description: Measured and computed data (Line B)
img: /assets/ch4/thumbnail/ch4_fig11.png
importance: 11
comments: true
---
...
<img src="{{ '/assets/ch4/ch4_fig11.png' | prepend: site.baseurl | prepend: site.url }}" alt="Figure 11" style="zoom:80%;" />

_Figure 11:_ Comparison between measured and computed data (Line B)
...
dir=Paper4_ostia_NEW/longLine/par_masw_q15_till5st
...
suresamp rf=0.1 |
sukill key=tracf a=45 | 
sukill key=tracf a=77 | 
sukill key=tracf a=84 | 
sukill key=tracf min=1 count=7 | 
...
translate=$x2,$y2 scale=$scale,$scale in=figs/fig11_fldr20.eps > figs/fig11_merge.eps
